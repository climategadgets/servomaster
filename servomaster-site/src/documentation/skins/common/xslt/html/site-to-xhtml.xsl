...
<!-- xsl:copy-of makes sure we copy <a href> as well as <a name>
  ...
  <xsl:template name="html-meta">
    <meta name="description" content="Haywire: High Level 1-Wire API"/>
    <meta name="keywords" content="1-wire network adapter bus branch API sensor temperature humidity pressure abstraction"/>
